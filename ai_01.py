#Задача - классифицировать по признакам 1й - длинна чешелистика, 2й - ширина чешелистика, 3й - длинна лепестка, 4й - ширина лепестка, что это за цветок.

import numpy as np

INPUT_DIM = 4 # количество параметров на входе: 1й - длинна чешелистика, 2й - ширина чешелистика, 3й - длинна лепестка, 4й - ширина лепестка
OUT_DIM = 3 # по количеству классов на выходе. Всего три класса у цветка Ирис: 'Setosa', 'Versicolor', 'Virginica'
H_DIM = 10 # количество нейронов в первом слое, я бы поставил 12, но автор поставил 10. Моя логика = 4 *3 = 12 вариантов.
